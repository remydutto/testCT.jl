...
The testCT.jl repo is part of the [control-toolbox ecosystem](https://github.com/control-toolbox).

| **Category** | **Badge** |
|-----------------------|-----------|
| **Documentation** | [![Stable Docs](https://img.shields.io/badge/docs-stable-blue.svg)](https://remydutto.github.io/testCT.jl/stable/) [![Dev Docs](https://img.shields.io/badge/docs-dev-8A2BE2.svg)](https://remydutto.github.io/testCT.jl/dev/) |
| **CI / Build** | [![Build Status](https://github.com/remydutto/testCT.jl/actions/workflows/CI.yml/badge.svg?branch=main)](https://github.com/remydutto/testCT.jl/actions/workflows/CI.yml?query=branch%3Amain) |
| **Test Coverage** | [![Coverage](https://codecov.io/gh/remydutto/testCT.jl/branch/main/graph/badge.svg)](https://codecov.io/gh/remydutto/testCT.jl) |
| **Release / Version** | [![Release](https://img.shields.io/github/v/release/remydutto/testCT.jl.svg)](https://github.com/remydutto/testCT.jl/releases) |
| **License** | [![License](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/remydutto/testCT.jl/blob/master/LICENSE) |
...
[issue-url]: https://github.com/remydutto/testCT.jl/issues
[first-good-issue-url]: https://github.com/remydutto/testCT.jl/contribute
